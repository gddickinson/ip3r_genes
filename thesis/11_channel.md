...
monomer prediction pipeline [R167] stops, and the sister family at about 5,000
...
in the protein record, an actual probe of the prediction database [R168], and
...
is an information-theoretic divergence [R178], because ray-finned fish are
