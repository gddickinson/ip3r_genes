...
the spread of published estimates, and its source [R188, R189, R190, R191, R192].
...
counted by the standard method [R173] and the mapping is the standard
least-common-ancestor one [R172].
...
**{fig:recon_matrix}.** The topology × variant matrix, with the deepest
...
stem** — older than crown Vertebrata [R186, R187], whose published estimates run 480 to
