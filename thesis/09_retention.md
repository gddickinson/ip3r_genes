...
**{fig:synteny_reach}.** Why synteny could not answer: the joint distribution
...
**{fig:character_matrix}.** Every genome × paralogue cell, ordered by assembly
...
false-discovery-rate procedure this project uses throughout [R170].
