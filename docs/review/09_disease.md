...
ataxic mouse [R38]. The finding replicated in Japanese [R39] and large European
[R40] cohorts, and the separately named SCA16 was shown to be the same entity —
heterozygous *ITPR1* deletion — rather than a distinct disorder [R118, R119].
The mechanism here is haploinsufficiency; the clinical context is reviewed
among the dominant ataxias [R121].

**SCA29.** *Missense* variants cause a congenital, non-progressive, autosomal
dominant ataxia [R41], consolidated as SCA29 in a multi-family case series
[R42]. At least one such variant is a demonstrated *gain* of function in the
suppressor domain [R120] — so the *ITPR1* ataxias are not a single mechanism
...
*ITPR1* variants **and** de novo heterozygous variants [R43]. Only the latter
act dominant-negatively, through a restricted repertoire of mutations
concentrated in the channel domain [R44] — exactly what §3.3 and §6.3 predict,
...
an inability to sweat, with morphologically normal eccrine glands [R45]. Three
...
dominant-negative effect on Ca<sup>2+</sup> transients [R46]; further families
followed [R51]; and a recurrent p.Thr1424Met was found in 33 affected
individuals from nine unrelated families, with unusually variable age of onset
and severity even within families [R47]. A spontaneous canine homozygous
...
protein levels — evidence of co-regulation across the family [R49].
...
acting through a dominant-negative mechanism [R48]. Any analysis treating the
...
anti-apoptotic and proliferative roles reported in cancer cells [R124] and
increased expression enhancing malignant properties in cholangiocarcinoma
[R125]. The mechanistic frame is §5.4–5.5: ER-to-mitochondrial Ca<sup>2+</sup>
transfer sets the apoptotic threshold, and Bcl-2-family proteins tune the
receptor to raise it [R123]. The therapeutic reading is the BIRD-2 peptide,
