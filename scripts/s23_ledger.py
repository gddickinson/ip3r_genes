...
def build(summaries: list[dict]) -> dict:
    ...
    for s in summaries:
        ...
        controls.append({
            ...
            "mir_loci": s.get("mir_loci", 0), "ryr_loci": s.get("ryr_loci", 0),
...
def main() -> int:
    ...
    write_tsv(OUT_DIR / "control_ledger.tsv",
              ["accession", "organism", "group", "expects_ryr", "mir_loci",
               "ryr_loci", "verdict", "why"], t["controls"])
